...
@AllArgsConstructor
@Builder
@ToString(exclude = {"disaster", "disasterZone"})
public class EvacuationRequest {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EvacuationRequest)) return false;
        EvacuationRequest that = (EvacuationRequest) o;
        return evacuationRequestId != null && evacuationRequestId.equals(that.evacuationRequestId);
    }
