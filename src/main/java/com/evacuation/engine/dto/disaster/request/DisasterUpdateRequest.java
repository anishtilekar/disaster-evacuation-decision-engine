...
import com.evacuation.engine.validation.disaster.ValidDisasterTimeRange;
...
@Builder
@ValidRawCoordinate
@ValidDisasterTimeRange
public class DisasterUpdateRequest implements HasRawCoordinates {
