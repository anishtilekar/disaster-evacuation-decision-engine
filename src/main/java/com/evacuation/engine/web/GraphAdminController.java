 ...
 * recompiling and swapping the hazard timeline all belong to the service. Two endpoints only —
 * listing arrives when something actually needs it, not in anticipation.
 */
@RestController
